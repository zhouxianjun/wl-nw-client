	...
	return function(e, t, n) {
		...
		1 : [function(e, t) {
			function n(e) {
				...
				this.capabilities = r,
				i.call(this),
				n = this.connection = io.connect(this.config.url),
				n.on("connect",
				function() {
				...
				n.on("remove",
				function(e) {
					var removes = s.callbacks.remove;
				...
				e.debug = !1,
				this.webrtc = new o(e),
				["mute", "unmute", "pause", "resume"].forEach(function(e) {
			...
			n.prototype.startLocalVideo = function() {
				var e = this;
				this.webrtc.startLocalMedia(null,
				function(t, n) {
		...
		3 : [function(e, t) {
			...
			n.prototype.emit = function(e) {
				...
				if (r) for (t = 0, n = r.length; n > t && r[t]; ++t) r[t].apply(this, [e].concat(o));
				return this
			},
		...
		5 : [function(e, t) {
			...
			t.exports = {
				support: !!s,
				dataChannel: o || i || s.prototype && s.prototype.createDataChannel,
				prefix: n,
		...
		2 : [function(e, t) {
			...
			n.prototype.startLocalMedia = function(e, t) {
				...
				r(o,
				function(e, i) {
					e || (o.audio && n.config.detectSpeakingEvents && n.setupAudioMonitor(i), n.localStream = i, n.config.autoAdjustMic && (n.gainController = new p(i), n.setMicIfEnabled(.5)), n.emit("localStream", i)),
					t && t(e, i)
				})
			},
			...
			o.prototype.handleMessage = function(e) {
				...
				"offer" === e.type ? this.pc.answer(e.payload,
				function(e, n) {
					t.send("answer", n)
		...
		13 : [function(e, t) {
			...
			a = navigator.userAgent.match("Chrome") && parseInt(navigator.userAgent.match(/Chrome\/(.*) /)[1], 10) >= 26,
			c = window.webkitAudioContext || window.AudioContext;
			t.exports = {
				support: !!n,
		...
		10 : [function(e, t) {
			function n(e, t) {
				var n;
				this.pc = new i.PeerConnection(e, t),
				o.call(this),
			...
			n.prototype._answer = function(e, t, n) {
				var o = this;
				this.pc.setRemoteDescription(new i.SessionDescription(e)),
				this.pc.createAnswer(function(e) {
					e.sdp = o._applySdpHack(e.sdp),
					o.pc.setLocalDescription(e),
					o.emit("answer", e),
					n && n(null, e)
				},
				function(e) {
			...
			n.prototype.createDataChannel = function(e, t) {
				...
				o = this.pc.createDataChannel(e, n)),
				o
			},
			t.exports = n
		},
		...
		12 : [function(e, t) {
			function n(e, t) {
				...
				for (var o = 0,
				i = t.length; i > o; o++) t[o] > n && t[o] < 0 && (n = t[o]);
				return n
			}
			var o = e("wildemitter");
			t.exports = function(e, t) {
				...
				a = d.createAnalyser(),
				a.fftSize = 512,
				a.smoothingTimeConstant = c,
				s = new Float32Array(a.fftSize),
				e.jquery && (e = e[0]),
				e instanceof HTMLAudioElement ? (r = d.createMediaElementSource(e), "undefined" == typeof h && (h = !0), u = u || -65) : (r = d.createMediaStreamSource(e), u = u || -45),
				r.connect(a),
				h && a.connect(d.destination),
				i.speaking = !1,
				i.setThreshold = function(e) {
					u = e
				},
				...
				var l = function() {
					setTimeout(function() {
						var e = n(a, s);
						i.emit("volume_change", e, u),
						e > u ? i.speaking || (i.speaking = !0, i.emit("speaking")) : i.speaking && (i.speaking = !1, i.emit("stopped_speaking")),
						l()
					},
					p)
				};
...
function() { !
	...
	function(e, t) {
		...
		n.indexOf = function(e, t, n) {
			for (var o = e.length,
			n = 0 > n ? 0 > n + o ? 0 : n + o: n || 0; o > n && e[n] !== t; n++);
			return n >= o ? -1 : n
		},
		...
		n.prototype.removeListener = function(e, n) {
			if (this.$events && this.$events[e]) {
				...
				if (t.util.isArray(o)) {
					for (var i = -1,
					r = 0,
					s = o.length; s > r; r++) if (o[r] === n || o[r].listener && o[r].listener === n) {
						i = r;
						break
					}
					if (0 > i) return this;
	...
	function(e, t) {
		...
		n.encodePacket = function(e) {
			...
			case "error":
				...
				d = e.advice ? a(r, e.advice) : ""; ("" !== h || "" !== d) && (u = h + ("" !== d ? "+" + d: ""));
				break;
			case "message":
				"" !== e.data && (u = e.data);
				break;
			case "event":
				...
				e.args && e.args.length && (l.args = e.args),
				u = s.stringify(l);
				break;
			case "json":
			...
			var f = [t, n + ("data" == p ? "+": ""), c];
			return null !== u && void 0 !== u && f.push(u),
			f.join(":")
		},
	...
	function(e, t) {
		...
		n.prototype.onData = function(e) {
			if (this.clearCloseTimeout(), (this.socket.connected || this.socket.connecting || this.socket.reconnecting) && this.setCloseTimeout(), "" !== e) {
				...
				i = n.length; i > o; o++) this.onPacket(n[o])
			}
			return this
		},
	...
	function(e, t, n) {
		...
		o.prototype.handshake = function(e) {
			...
			if (this.isXDomain() && !t.util.ua.hasCORS) {
				...
				p.open("GET", s, !0),
				this.isXDomain() && (p.withCredentials = !0),
		...
		o.prototype.getTransport = function(e) {
			for (var n, o = e || this.transports,
			i = 0; n = o[i]; i++) if (t.Transport[n] && t.Transport[n].check(this) && (!this.isXDomain() || t.Transport[n].xdomainCheck(this))) return new t.Transport[n](this, this.sessionid);
			return null
		},
		o.prototype.connect = function(e) {
			...
			this.handshake(function(o, i, r, s) {
				function a(e) {
					...
					n.transport ? (n.transport.ready(n,
					function() {
						n.connecting = !0,
	...
	function(e, t, n) {
		...
		o.prototype.send = t.util.ua.iDevice ?
		function(e) {
			var t = this;
		...
		o.prototype.payload = function(e) {
			for (var t = 0,
			n = e.length; n > t; t++) this.packet(e[t]);
			return this
		},
